...
public class Get_Chat_history extends AsyncTask<String , Integer, Void>{

	String auth1,accesstoken,To_id,responseBody;
	Context ctx;
	SharedPreferences preferences;
	String responseString;
	SharedPreferences sp;

	public Get_Chat_history(Context ctx, String accesstoken,String To_id, SharedPreferences sp) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			...
			HttpPost httppost = new HttpPost("http://54.86.25.38:1338/update_user_profile");

			try {
				// Add your data
				List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
				nameValuePairs.add(new BasicNameValuePair("accesstoken",accesstoken ));
				nameValuePairs.add(new BasicNameValuePair("name", To_id));
