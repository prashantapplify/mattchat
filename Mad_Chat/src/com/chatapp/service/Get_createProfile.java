...
public class Get_createProfile  extends AsyncTask<String , Integer, Void>{

	String auth1,auth2,android_id,phone_no,responseBody;
	Context ctx;
	...
	public Get_createProfile(Context ctx,ProgressDialog bar, String android_id,String phone_no, SharedPreferences sp) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			...
			HttpPost httppost = new HttpPost(Constant_URL.update_user_profile);

			try {
				// Add your data
				List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
				nameValuePairs.add(new BasicNameValuePair("accesstoken",android_id ));
				nameValuePairs.add(new BasicNameValuePair("name", phone_no));
