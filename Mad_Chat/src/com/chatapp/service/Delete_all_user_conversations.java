...
public class Delete_all_user_conversations extends AsyncTask<String , Integer, Void>{
...
//	ProgressDialog bar;
	...
	public Delete_all_user_conversations(Context ctx, String accesstoken,String chatid,String groupid,String Chat_Type, SharedPreferences sp,ListView chat_room_list,LinearLayout chat_room_list1) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			...
			HttpPost httppost = new HttpPost(Constant_URL.delete_all_user_conversations);
			Log.d("Delete", accesstoken+"//"+chatid+"//"+groupid+"//"+Chat_Type);
			try {
				// Add your data
	...
	protected void onPostExecute(Void result1) 
	{
		try {
			...
			if(object.has("error")){
				...
				chat_room_list.setAdapter(null);
