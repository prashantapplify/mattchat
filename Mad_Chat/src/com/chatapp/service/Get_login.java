...
public class Get_login extends AsyncTask<String , Integer, Void>{
	...
	public Get_login(Context ctx,ProgressDialog bar, String android_id,String phone_no, SharedPreferences sp) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			Log.d("Get_Login", phone_no+"//"+android_id);
			HttpClient httpclient = new DefaultHttpClient();
			HttpPost httppost = new HttpPost(Constant_URL.register_user);

			try {
				// Add your data
				List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
				nameValuePairs.add(new BasicNameValuePair("phone", phone_no));
