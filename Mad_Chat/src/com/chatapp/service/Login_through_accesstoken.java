...
public class Login_through_accesstoken extends AsyncTask<String , Integer, Void>{
	...
	public Login_through_accesstoken(Context ctx,ProgressDialog bar, String android_id,String phone_no, SharedPreferences sp) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			...
			HttpPost httppost = new HttpPost(Constant_URL.login_through_accesstoken);

			try {
				// Add your data
				List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
				nameValuePairs.add(new BasicNameValuePair("accesstoken", phone_no));
				nameValuePairs.add(new BasicNameValuePair("devicetoken", android_id));
