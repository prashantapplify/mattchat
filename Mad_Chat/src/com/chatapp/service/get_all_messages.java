...
public class get_all_messages extends AsyncTask<String , Integer, Void>{
	...
	public get_all_messages(Context ctx, String accesstoken,String senderid, SharedPreferences sp, ListView chat_room_list, int w, int h, InputMethodManager imm,String Chat_Type,String Chatid, LinearLayout chat_room_list1) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			...
			if(Chat_Type.equalsIgnoreCase("0")){
				httppost = new HttpPost(Constant_URL.get_all_messages);
			}
			else{
				httppost = new HttpPost(Constant_URL.get_all_messages_of_group);
			}
...
//				Chat_Room.Chat_List_arrayList=new ArrayList<Get_Chat_model>();
				...
				ChatList_adp=new Get_Chat_Adapter(ctx, Chat_Room.Chat_List_arrayList,w,h,sp,"all_msg",imm,chat_room_list1);
